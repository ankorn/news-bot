...
def parse_article(article_tree):
    ...
    article.tag = article_tree.find('span', {'class' : 'card-full-news__info-item card-full-news__rubric'}).get_text()
    date = article_tree.find('time', {'class' : 'card-full-news__info-item card-full-news__date'}).get_text()
